...
public class KuisTebakBacaanTanwinActivity extends AppCompatActivity {
    ...
    public void newlevel(){
        ...
        jw1.setBackgroundResource(bacaantanwin.getimagesoal(j1));
        jw2.setBackgroundResource(bacaantanwin.getimagesoal(j2));
        jw3.setBackgroundResource(bacaantanwin.getimagesoal(j3));
